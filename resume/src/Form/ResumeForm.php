...
class ResumeForm extends FormBase {
   ...
   */
   ...
   // drupal_set_message($this->t('@can_name ,Your application is being submitted!', array('@can_name' => $form_state->getValue('candidate_name'))));
      ...
      // $valid_elements = ["candidate_name","candidate_mail","candidate_number","candidate_dob","candidate_gender","candidate_confirmation","candidate_copy"];
      ...
      db_insert("module_resume")->fields($insertArr)->execute();
